...
private[httpreporter] class UserBreakdownBuffer(val totalUserEstimate: Long) {
...
private[httpreporter] case class UserBreakdown(active: Long, waiting: Long, done: Long)
