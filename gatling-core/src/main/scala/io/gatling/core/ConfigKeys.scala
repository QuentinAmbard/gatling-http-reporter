...
object ConfigKeys {
  ...
  object data {
    ...
    object http {
      val Light = "gatling.data.graphite.light"
      val Url = "gatling.data.http.url"
      val WritePeriod = "gatling.data.http.writePeriod"
      val StartUrl = "gatling.data.http.startUrl"
      val StopUrl = "gatling.data.http.stopUrl"
      val ReportUrl = "gatling.data.http.reportUrl"
    }
  }
