...
object DataWriterType {
  ...
  private val AllTypes = Seq(ConsoleDataWriterType, FileDataWriterType, GraphiteDataWriterType, LeakReporterDataWriterType, HTTPReporterDataWriterType)
...
object HTTPReporterDataWriterType extends DataWriterType("http", "io.gatling.httpreporter.HTTPDataWriter")
