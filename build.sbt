...
lazy val httpreporter = gatlingModule("gatling-http-reporter")
  .dependsOn(core % "compile->compile;test->test")
  .settings(libraryDependencies ++= httpReporterDependencies)
...
lazy val app = gatlingModule("gatling-app")
  .dependsOn(core, http, jms, jdbc, redis, graphite, httpreporter, charts)
